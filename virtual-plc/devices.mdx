...
In the OTee user interface, navigate to the Devices page and select the device you want to remove. Then, remove the device by hitting the “Delete device” button on your device’s page. 