...
Start by downloading our example project, which uses a function block to simulate a heat exchanger and a built-in PID controller to steer the process based on the user's target temperature settings.
